...
public class MeanBlur extends AbstractBrush {
    ...
    public BrushContext createContext(DrawableLayer target) {
        return new BlurContext(this, target);
    }

    private static class BlurContext extends BrushContextBase<MeanBlur> {

        public BlurContext(MeanBlur brush, DrawableLayer layer) {
            super(brush, layer);
        }
        ...
        protected void initialize() {
            ...
            Arrays.fill(array, 1f / (brush.kernelHeight * brush.kernelWidth));
            BufferedImageOp op;
