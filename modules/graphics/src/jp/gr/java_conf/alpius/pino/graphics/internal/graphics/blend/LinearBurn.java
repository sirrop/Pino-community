...
public class LinearBurn implements SimpleBlender.BlendStrategy {
    private interface SingletonHolder {
        LinearBurn instance = new LinearBurn();
    }

    public static LinearBurn getInstance() {
    ...
    public int calc(int src, int dst) {
        ...
        int burnRed = srcRed + dstRed - 255;
        int burnGreen = srcGreen + dstGreen - 255;
        int burnBlue = srcBlue + dstBlue - 255;
