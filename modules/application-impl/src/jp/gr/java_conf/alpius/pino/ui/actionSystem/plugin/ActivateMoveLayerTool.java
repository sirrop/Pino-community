...
import jp.gr.java_conf.alpius.pino.tool.plugin.MoveLayerTool;
import jp.gr.java_conf.alpius.pino.ui.actionSystem.Action;
import jp.gr.java_conf.alpius.pino.ui.actionSystem.ActionEvent;

public class ActivateMoveLayerTool implements Action {
    @Override
    public void performAction(ActionEvent e) {
        Pino.getApp().getService(ToolManager.class).activate(new MoveLayerTool());
    }
}
