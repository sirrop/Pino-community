...
import jp.gr.java_conf.alpius.pino.gui.widget.skin.DrawToolEditorSkin;
import jp.gr.java_conf.alpius.pino.tool.plugin.DrawTool;
import jp.gr.java_conf.alpius.pino.ui.conrtols.Editor;

public class DrawToolEditor extends Editor<DrawTool> {
    @Override
    protected Skin<?> createDefaultSkin() {
        return new DrawToolEditorSkin(this);
    }
}
