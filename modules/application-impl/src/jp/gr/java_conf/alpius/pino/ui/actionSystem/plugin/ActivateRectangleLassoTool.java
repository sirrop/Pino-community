...
import jp.gr.java_conf.alpius.pino.tool.plugin.RectangleLassoTool;
import jp.gr.java_conf.alpius.pino.ui.actionSystem.Action;
import jp.gr.java_conf.alpius.pino.ui.actionSystem.ActionEvent;

public class ActivateRectangleLassoTool implements Action {
    @Override
    public void performAction(ActionEvent e) {
        Pino.getApp().getService(ToolManager.class).activate(new RectangleLassoTool());
    }
}
