package jp.gr.java_conf.alpius.pino.internal.beans;
...
import static jp.gr.java_conf.alpius.pino.core.util.Strings.isNullOrEmpty;
...
public class BeenPeer<T> {
    ...
    public BeenPeer(@NotNull T bean) {
        ...
        @Nullable ResourceBundle bundle = Utils.findBundle(bean.getClass());
